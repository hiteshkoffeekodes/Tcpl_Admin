            ...
            <table className="min-w-full">
              <thead>
                <tr className="bg-[--white] border border-t-0 border-b border-[--serviceborder] sticky shrink-0 top-[0px] z-[1] text-small font-semibold">
                  ...
                  <th className="border-b py-2 border-[--serviceborder] w-[10%]">
                    Date
                  </th>
                  <th className="border-b py-2 border-[--serviceborder] text-start  pl-3  ">
                    Service Name
                  </th>
                  <th className="border-b py-2 border-[--serviceborder] text-start  pl-3  w-[17%]">
                  ...
                  <th className="border-b py-2 border-[--serviceborder] border-l text-center w-[2%] p-3">
                    Action
                  </th>
                </tr>
              </thead>
...
export default ServicesChargesTable;
