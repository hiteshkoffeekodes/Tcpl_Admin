...
function SlabModel({ model, setModel, modeltitle, children }: any) {
  ...
  return (
    <>
      {model && (
        <div className=" overflow-auto overflow-x-hidden fixed top-0 right-0 left-0 z-[4] justify-center items-center w-full md:inset-0 h-[calc(100%-0rem)] max-h-full flex bg-black/50  transition-opacity duration-700">
