  ...
  return (
      ...
      <div className="flex justify-between text-font-medium border-t-0 border border-[--serviceborder] border-l-0">
        <div className="border border-[--serviceborder] border-y-0 hidden md:flex">
              ...
              <div className="absolute mt-8 w-20 bg-[--white] border rounded shadow-lg z-10 left-0 top-4">
                {itemsPerPageOptions.map((option) => (
                  <button
                    ...
                    className="block px-4 py-2 text-small text-[--darkblue] hover:bg-[--serviceblue] w-full"
                  >
                    {option}
                  </button>
                ))}
          ...
          <div className="relative border border-[--serviceborder] border-y-0 border-x-0 flex justify-between gap-5 px-3 py-2">
            <p>Select</p>
              ...
              <div className="absolute mt-8 w-32 bg-[--white] border rounded shadow-lg z-10 left-0 top-4">
                {selectOptions.map((option) => (
                  <button
                    ...
                    className="block px-4 py-2 text-small text-[--darkblue] hover:bg-[--serviceblue] w-full text-left"
                  >
                    {option}
                  </button>
                ))}
        ...
        <div className="flex space-x-5 border border-[--serviceborder] border-y-0">
